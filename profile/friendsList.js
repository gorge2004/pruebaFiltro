...
import { Container, Header, Footer, Grid, Col, Text, Row, Item, ListItem, Left, Body, Right, Button, Thumbnail, Icon, Input } from 'native-base';
...
search = (txt)=>{
    ...
    const arrayData = this.state.friends;
    let result = [];
